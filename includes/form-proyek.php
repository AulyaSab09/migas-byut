...
<style>
    ...
    .project-form textarea:focus {
        outline: none;
        border-color: #F5A623;
        box-shadow: 0 0 0 4px rgba(245, 166, 35, .18), 0 8px 22px rgba(214, 170, 94, .12);
...
<div class="flex flex-wrap gap-3">
    <button type="submit" class="text-white px-6 py-3 rounded-xl font-semibold transition hover:opacity-90" style="background: #F5A623; box-shadow: 0 10px 24px rgba(245,166,35,.22);"><?= isset($project) ? 'Simpan Perubahan' : 'Simpan Proyek' ?></button>
    <button type="reset" class="px-6 py-3 rounded-xl font-semibold transition hover:opacity-90" style="background: #FFF2D9; color: #7A5A1E; border: 1px solid #FAD9A1;">Reset</button>
    <a href="proyek.php" class="px-6 py-3 rounded-xl font-semibold transition hover:opacity-90" style="background: #FFFFFF; color: #7A5A1E; border: 1px solid #FAD9A1;">Batal</a>
</div>